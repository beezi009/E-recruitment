...
<div class="container-fluid">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="firstnames"  placeholder="Enter your firstnames" name="firstnames">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="id_number"  placeholder="Enter your id_number" name="id_number">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="nationality"  placeholder="Enter your Nationality" name="nationality">
    </div>

    <div class="form-group">
      <label for="address">Residetial Address</label>
      <input type="text" class="form-control" id="address"  placeholder="Enter your Residential address" name="address">
    </div>

    <div class="form-group">
      <label for="postal_address">Postal Address</label>
      <input type="text" class="form-control" id="postal_address" placeholder="Enter your Postal Address" name="postal_address">
    </div>
